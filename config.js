...
export const WHITE_PAWN_RANGE_DY = [-2, -1, -1, -1];
export const WHITE_PAWN_RANGE_DX = [0, -1, 0, -1];

export const BLACK_PAWN_RANGE_DY = [2, 1, 1, 1];
export const BLACK_PAWN_RANGE_DX = [0, -1, 0, -1];
